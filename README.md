...
- **Gemini 1.5 / 2.0 LLM**: Powers the intelligence behind each agent
...
**Nainesh**  
*Computer Engineering (B.S.) | Data Science (M.S.)*  

A portfolio project demonstrating expertise in:
- **Agentic AI**: Designing multi-agent workflows with CrewAI
- **LLM Integration**: Leveraging Gemini 1.5/2.0 Pro models for reasoning and planning
- **Full-Stack Development**: Building end-to-end applications with FastAPI and Streamlit
